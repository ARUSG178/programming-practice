...
public class FunctionsExercises {
    ...
    public static void welcome() { System.out.println("¡Te doy la bienvenida al curso de Java desde cero!"); }
    ...
    public static boolean esMayor(int edad) { return edad >= 18; }

    // 7. Implementa una función que reciba una cadena y retorne su longitud.
    // public static int longitudString(String texto) { ... }
    public static int longitudString(String texto) { return texto.length(); }
    // 8. Crea un método que reciba un array de enteros, calcula su media y lo retorna.
    // public static double calcularMedia(int[] numeros) { ... }
    public static double calcularMedia(int[] numeros) {
        double prom = 0;
        int idx = 0;
        for(var uwu : numeros) { idx++; prom += uwu; }
        return prom / idx;
    }
